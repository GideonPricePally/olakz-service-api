...
import paymentConfig from '@/libs/payment/config/payment.config';
...
function generateModulesSet() {
  const imports: ModuleMetadata['imports'] = [
    ConfigModule.forRoot({
      isGlobal: true,
      load: [appConfig, databaseConfig, redisConfig, authConfig, mailConfig, paymentConfig, cloudinaryConfig],
      envFilePath: ['.env'],
    }),
  ];
  ...
  switch (modulesSet) {
    case 'monolith':
      customModules = [HttpModule, ApiModule, LibsModule, bullModule, BackgroundModule, cacheModule, dbModule, i18nModule, loggerModule, MailModule];
      break;
    case 'api':
      customModules = [HttpModule, ApiModule, LibsModule, bullModule, cacheModule, dbModule, i18nModule, loggerModule, MailModule];
      break;
    case 'background':
      customModules = [HttpModule, bullModule, LibsModule, BackgroundModule, cacheModule, dbModule, i18nModule, loggerModule];
      break;
    default:
