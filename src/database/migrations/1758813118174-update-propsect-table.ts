...
export class UpdatePropsectTable1758813118174 implements MigrationInterface {
    name = 'UpdatePropsectTable1758813118174'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "prospect" DROP COLUMN "last_name"
        `);
        await queryRunner.query(`
            ALTER TABLE "prospect" DROP CONSTRAINT "UQ_600609771a0e53e9236635d04f5"
        `);
        await queryRunner.query(`
            ALTER TABLE "prospect" DROP COLUMN "first_name"
        `);
    }
