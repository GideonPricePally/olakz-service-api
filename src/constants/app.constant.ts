...
export const TWENTY_FOUR_HOURS_MILL = 24 * 60 * 60 * 1000;
export const DEFAULT_PAGE_LIMIT = 10;
export const DEFAULT_CURRENT_PAGE = 1;
export const SYSTEM_USER_ID = 'system';

export const default_currencies = [{ code: 'ngn', name: 'naira', symbol: '₦', symbol_native: '₦', is_default: true, includes_tax: true }];
